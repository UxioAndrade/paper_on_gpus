...
\title{Report on potential GPU'S for Name} % Article title

\author{\textsc{Uxío García Andrade} \\[1ex] % Your name
	\normalsize Laboratorio de Fundamentos de Computadores I\\
	\normalsize Grupo 01 \\ % Your institution
	\normalsize \uxio.garcia.andrade@rai.usc.es % Your email address
\date{\06/03/2018} % Leave empty to omit a date
\renewcommand{\maketitlehookd}{
	\begin{abstract}
		\noindent Unas 100 palabras describiendo el problema que se aborda y las conclusiones principales del documento.  Debe ser corto.\\\mbox{}\\
